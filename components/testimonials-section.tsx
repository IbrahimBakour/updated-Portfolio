...
export function TestimonialsSection() {
  ...
  return (
    <section id="testimonials" className="py-20 bg-muted/5 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="max-w-4xl mx-auto mb-12">
          <div className="relative">
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-primary via-secondary to-accent rounded-2xl blur-sm opacity-30 animate-pulse" />
                  ...
                  <div className="flex justify-center gap-1 mb-6">
                    {[...Array(5)].map((_, i) => (
                      <Star
                        ...
                        className={cn(
                          "h-5 w-5",
                          i < testimonials[currentIndex].rating ? "text-accent fill-accent" : "text-muted-foreground",
                        )}
                      />
                    ))}
                  </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mt-16">
          <div className="text-center">
            <div className="text-3xl font-bold text-primary mb-2 neon-glow">50+</div>
        ...
        <div className="text-center mt-16">
          ...
          <Button
            size="lg"
            className="bg-gradient-to-r from-primary to-secondary hover:from-primary/90 hover:to-secondary/90 text-white font-semibold px-8 py-3 transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-primary/25"
